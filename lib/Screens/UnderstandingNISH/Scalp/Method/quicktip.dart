...
void quicktip(BuildContext context) {
  int currentStep = 1;
  int totalSteps = 4;
      ...
      return Align(
        ...
        child: StatefulBuilder(
          builder: (context, setState) {
            String title = "Healthy hair begins in a healthy scalp";
              ...
              switch (step) {
                case 1:
                  return _buildCard(
                    title: title,
                    description:
                        "Massage is your best friend—5 minutes can make a big difference",
                  );
                case 2:
                  return _buildCard(
                    title: title,
                    description:
                        "If your scalp is angry, your hair will be too",
                  );
                case 3:
                  return _buildCard(
                      title: title,
                      description:
                          "Think of your scalp like garden soil—feed it, hydrate it, and keep it calm.");
                case 4:
                  return _buildCard(
                      title: title,
                      description:
                          "Don’t wait for problems—scalp care is daily care.");
