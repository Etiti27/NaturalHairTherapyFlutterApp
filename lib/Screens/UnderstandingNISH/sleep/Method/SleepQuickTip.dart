...
void SleepQuickTip(BuildContext context) {
  int currentStep = 1;
  int totalSteps = 4;
      ...
      return Align(
        ...
        child: StatefulBuilder(
          builder: (context, setState) {
            String title = "Your hair rests when you rest. Don’t skip sleep";
            ...
            Widget buildSlidingCard(int step) {
              switch (step) {
                case 1:
                  return _buildCard(
                    title: title,
                    description: "No product can replace a good night’s sleep",
                  );
                case 2:
                  return _buildCard(
                    title: title,
                    description:
                        "Sleep is the overnight delivery system for growth.",
                  );
                case 3:
                  return _buildCard(
                      title: title,
                      description:
                          "Silk pillowcase + 8 hours = better retention.");
                case 4:
                  return _buildCard(
                      title: title,
                      description:
                          "Melatonin flows when you rest. Help it do its job.");
