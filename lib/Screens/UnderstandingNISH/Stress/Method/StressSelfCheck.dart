...
StressSelfcheckQuestion(BuildContext context) {
  int currentStep = 1;
  int numberOfPages = 6;
              ...
              switch (step) {
                case 1:
                  return NutritionModal(
                    text1: 'I feel mentally exhausted or overwhelmed.',
                ...
                case 2:
                  return NutritionModal(
                    text1: 'I sleep poorly or wake up tired.',
                    text3: listviewBuilder(
                      optionsQuestion: optionsQuestion,
                      answer: answer2,
                      onChanged: (String? v) {
